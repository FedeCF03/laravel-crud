              ...
              <div class="card-body">
                  <form method="POST" action="{{ route('update') }}" enctype="multipart/form-data" >
                     ...
                     @include('includes.avatar')
                      ...
                      <div class="row mb-3">
                        <label for="imagen" class="col-md-4 col-form-label text-md-end">{{ __('avatar') }}</label>

                        <div class="col-md-6">
                            <input id="imagen" type="file" class="form-control @error('imagen') is-invalid @enderror" name="imagen" value="">
